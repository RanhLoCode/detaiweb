            ...
            <div class="media">
                <div class="media-left media-middle">
                    <P class="text-success">
                        <span data-toggle="modal" data-target="#changeAvatar" class="glyphicon glyphicon-pencil" STYLE="cursor: pointer"></span>
                    </P>
                    <img class="img-rounded" src="../image/avatar/<?php echo $row['Hinh'] ?>"
                         width="150"/>
                    <div id="changeAvatar" class="modal fade" role="dialog">
                        <div class="modal-dialog">
                            <form action="../controller/nhanvien/changeAvatar.php" method="post" enctype="multipart/form-data" class="frmChangeAvatar">
                                    <div class="modal-content">
                                        ...
                                        <DIV CLASS="modal-body">
                                            <div class="container-fluid text-center">
                                                <img CLASS="img-rounded avatar" src="../image/avatar/<?php echo $row['Hinh'] ?>" width="50%"/>
                                            </div>
                                            <input type="hidden" value="<?php echo $row['ID'] ?>" name="ID">

                                            <input class="txtAvatar" STYLE="margin-top:10px;" CLASS="form-control" type="file" name="txtAvatar" accept="image/x-png, image/gif, image/jpeg" >
